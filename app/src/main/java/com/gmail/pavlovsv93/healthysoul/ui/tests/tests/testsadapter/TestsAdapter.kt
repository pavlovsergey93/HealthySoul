...
import com.gmai.pavlovsv93.healtysoul.domain.models.tests.*
...
class TestsAdapter(private val onClick: ClickedOnTest) :
            ...
            PARENT_TYPE -> {
                ParentViewHolder(
                    LayoutInflater.from(parent.context)
                        .inflate(R.layout.fragment_tests_recyclerview_item_parent, parent, false)
                )
            }
            else -> {
                ChildViewHolder(
                    LayoutInflater.from(parent.context)
                        .inflate(R.layout.fragment_tests_recyclerview_item_child, parent, false)
                )
            }
        }
    }
